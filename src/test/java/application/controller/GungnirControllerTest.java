...
class GungnirControllerTest {
    ...
    void findByAddress() throws Exception {
        mockMvc.perform(Payload.GUNGNIRS_SEARCH_FINDBYADDRESS.getRequest(Payload.buildAddress(configuration)))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.system.groupId").value(Matchers.matchesPattern("[a-z]+")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.system.artifactId").value(Matchers.matchesPattern("[a-z]+")))
